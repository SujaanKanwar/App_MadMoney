package com.example.sujan.madmoney.RegisterUser;
...
public class RegisterUserActivity extends AppCompatActivity implements CreateUserConnector.OnTaskComplete {
    ...
    private void storeUserData(String apkTreeArray, String userAddressId) {
        ...
        FileOperations fileOperations = new FileOperations(context, Constants.APK_FILE_NAME);
        fileOperations.write(apkTreeArray);

        SharedPreferences setting = this.getSharedPreferences(Constants.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = setting.edit();
        editor.putString(Constants.USER_NAME, nameView.getText().toString());
        editor.putString(Constants.USER_PASSWORD, nameView.getText().toString());
        editor.putString(Constants.USER_ADDRESS_ID, userAddressId);
