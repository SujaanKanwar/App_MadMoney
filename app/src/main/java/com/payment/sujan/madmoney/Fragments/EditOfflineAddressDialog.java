...
public class EditOfflineAddressDialog extends DialogFragment {
    ...
    private void setUserAddressValues(View view, String deviceName) {
        com.payment.sujan.madmoney.Resources.DBAddressBook dbAddressBook = new com.payment.sujan.madmoney.Resources.DBAddressBook(getActivity().getApplicationContext());
        List<com.payment.sujan.madmoney.AppData.BTAddress> dbBTAddressBookList = dbAddressBook.selectBTAddress();
        for (com.payment.sujan.madmoney.AppData.BTAddress userAddress : dbBTAddressBookList) {
