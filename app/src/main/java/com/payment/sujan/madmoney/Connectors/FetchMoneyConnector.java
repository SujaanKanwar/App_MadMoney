...
public class FetchMoneyConnector {
    public FetchMoneyConnector(com.payment.sujan.madmoney.Fragments.WalletFragment walletFragment) {
        onTaskCompleteListner = walletFragment;
    }

    private static final String LOGGER_TAG = "CreateUserServiceCall";

    private static final String createUserUrl = "http://192.168.0.108/madmoneyservice.svc/fetchmoney";
