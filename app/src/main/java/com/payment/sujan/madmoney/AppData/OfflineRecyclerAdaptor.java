...
public class OfflineRecyclerAdaptor extends RecyclerView.Adapter<OfflineRecyclerAdaptor.ViewHolder> {
    ...
    private List<com.payment.sujan.madmoney.AppData.BTAddress> dbBTAddressBookList;
    private com.payment.sujan.madmoney.Resources.DBAddressBook dbAddressBookStore;
    ...
    public OfflineRecyclerAdaptor(Context context, View.OnDragListener onDragListener, View.OnClickListener onClickListener) {
        ...
        this.dbAddressBookStore = new com.payment.sujan.madmoney.Resources.DBAddressBook(context);
